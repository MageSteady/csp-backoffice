...
namespace MageSteady\CspBackoffice\Model\ResourceModel\ViolationReport;

use Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection;
use MageSteady\CspBackoffice\Model\ResourceModel\ViolationReport as ViolationReportResourceModel;
use MageSteady\CspBackoffice\Model\ViolationReport as ViolationReportModel;
...
class Collection extends AbstractCollection
{
     ...
     * @inheritDoc
     */
    protected $_idFieldName = 'violationreport_id';
    ...
    protected function _construct()
    {
        $this->_init(
            ...
            ViolationReportResourceModel::class
        );
    }
}
